...
- Tagged dataset: `artifacts\manual_checks\offline_rule_assets_verification\tagged.jsonl`
- Error summary: `artifacts\manual_checks\offline_rule_assets_verification\error_summary.json`
- Output path: `artifacts\manual_checks\offline_rule_assets_verification\rule_assets.jsonl`
- Asset count: `3`
...
| OA_TRUE_DISJOINT_VAR_BINARY | disjoint_sides | 1 | 0 | 1.0000 | 1.0000 | 0.0000 | needs_review |

## Recommendation

Prioritize the top offline assets with clean true support and low current mainline slice accuracy: OA_TRUE_SINGLETON_LHS_TO_BINARY(support_true=2, mainline_acc=0.1000), OA_TRUE_SINGLETON_WITH_TARGET_SHARED_LHS(support_true=1, mainline_acc=0.2000), OA_TRUE_DISJOINT_VAR_BINARY(support_true=1, mainline_acc=1.0000). Keep them offline-first; do not promote wording into P1_2_3 without a dedicated smoke branch.
...
- Confidence: `low`
- Support: true=1, false=0, true_rate=1.0000
- Current mainline slice accuracy: `1.0000`
- Current mainline slice true accuracy: `1.0000`
- Status: `needs_review`
- Prompt policy: `do_not_inherit_wording`
- Rule text: If Equation 1 uses disjoint variable sets and has a variable-vs-binary shape, treat it as a narrow collapse family and store it as an offline TRUE asset.
- Notes: This is the dominant disjoint-sides shape on smoke and is cleanly true-heavy.
- Support examples: `p3`
- Failure examples: `none`
- Mainline error buckets: `none`
